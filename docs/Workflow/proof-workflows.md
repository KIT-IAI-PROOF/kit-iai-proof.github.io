...
A workflow consists of a combination of workflow elements that must be conducted in a particular order and implemented 
using several software tools.
A *PROOF Workflow* defines how blocks are coupled and which outputs and inputs are connected to allow data transfer.
...
![PROOF Workflow Structure](2024-06-28_WorkflowHierarchy.png)
